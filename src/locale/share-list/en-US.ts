export default {
  'sharelist.tab.recv': 'I received',

  'sharelist.tab.send': 'I sent',
  'sharelist.tab.send.shareTo': 'Share to:',
  'sharelist.tab.send.public': 'Everyone',
  'sharelist.tab.send.includeFiles': 'Include files or directories:',

  'sharelist.list.actions.delete': 'Do you want to delete this share? ',
  ...
  'sharelist.dialog.fields.receivers': 'Receivers',
  'sharelist.dialog.fields.code': 'Extraction code',
  ...
  'sharelist.dialog.extra.receivers':
    'Enter the user name or email address to query and select, if no user is selected, everyone can download the file through this sharing link',
  'sharelist.dialog.extra.code':
    'The extraction code can be any non-empty string',
  'sharelist.dialog.extra.overTime':
    'The expired file will no longer be extractable, if you do not fill in this item, it will be permanently valid'
}
